...
public:
    RenderKernel(int width, int height,
                 ...
                 sycl::accessor<Triangle, 1, sycl::access::mode::read, sycl::access::target::device> emissive_triangle_buffer_accessor,
        ...
        m_emissive_triangle_buffer_access(emissive_triangle_buffer_accessor),
...
private:
    ...
    sycl::accessor<Triangle, 1, sycl::access::mode::read, sycl::access::target::device> m_emissive_triangle_buffer_access;
